...
public class RestClient {
	...
	private static String readAllStudents() {
		...
		ResponseEntity<String> response = client.exchange("http://localhost:8080/register", HttpMethod.GET, entity, String.class);
	...
	private static void login() {
		...
		ResponseEntity<String> response = client.exchange("http://localhost:8080/login", HttpMethod.POST, entity, String.class);
